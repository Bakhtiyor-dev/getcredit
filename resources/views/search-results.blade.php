        ...
        <div class="card my-5 col-lg-8 mx-auto">
            ...
            <div class="card-body">
                <form class="d-flex"
                      action="{{route('search')}}"
                      method="GET">
                    <input class="form-control me-2" name="query" type="search" value="{{$query}}" placeholder="Поиск"
                           aria-label="Search">
                        ...
                        <div class="card-body p-0">
                            <div class="list-group border-0 rounded-0">
                                @foreach($test->answers as $answer)
                                    <label class="list-group-item list-group-item-action @if($answer['id'] === $test->correct_answer_id) text-success @endif">
                                        {{$answer['body']}}
                                    </label>
                                @endforeach
                            </div>
